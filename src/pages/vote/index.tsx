    ...
    <Layout>
      ...
      <main className="container padding-vert--lg">
        <p>
          ...
          <a href="https://visitor.gogatsusai.jp/project/501?action=vote&utm_source=qr&utm_medium=project-flyer&utm_campaign=project-flyer-evoke">
            こちらのリンク
          </a>
          から五月祭グランプリへの投票をお願いしております。1分ほどで完了しますので、次の動画を参考に投票をお願いします！
        </p>
        <div className={styles.container}>
          <img src="/img/mf99-vote.png" width={"500px"} height={"500px"}></img>
          <video
            src={howToVoteVideo}
            controls
